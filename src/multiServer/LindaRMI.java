...
public interface LindaRMI extends Remote {
	 ...
	 */
	//public void eventRegister(Tuple template, Callback callback) throws RemoteException;	
	
	/** To debug, prints any information it wants (e.g. the tuples in tuplespace or the registered callbacks), prefixed by <code>prefix</code. */
	public void debug(String prefix) throws RemoteException;

 	public Tuple tryTake_aux(Tuple t) throws RemoteException;

	public Tuple tryRead_aux(Tuple t) throws RemoteException;

        public void Actualiser(boolean bool, Attente a) throws RemoteException;

        public void write_aux(Tuple tuple) throws RemoteException;				
	public String getURI()throws RemoteException;
 
 public  void addListeServer(LindaRMI server) throws RemoteException;
	public ArrayList<LindaRMI> getListeServer() throws RemoteException;
   public  void ActualiserListeServer(String uri,int PORT,LindaRMI toAdd)throws RemoteException ;
}
